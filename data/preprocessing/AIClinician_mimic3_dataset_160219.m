...
tic
     save('/home/yusuf/Yusuf/Kuliah/AI/Project/ICU/JC-Reproduce/data/cohort/Data_100219.mat', '-v7.3');
toc
...
tic
     save('/home/yusuf/Yusuf/Kuliah/AI/Project/ICU/JC-Reproduce/data/cohort/Data_110219.mat', '-v7.3');
toc
...
% ponytail: clear stale reformat3 from sepsis3_def.m workspace
clear reformat3
...
% ponytail: clear stale reformat4 from sepsis3_def.m workspace (type conflict prevents silent overwrite)
clear reformat4
...
writetable(MIMICtable, '/home/yusuf/Yusuf/Kuliah/AI/Project/ICU/JC-Reproduce/data/raw/MKdataset07Feb17.csv', 'Delimiter', ',');
