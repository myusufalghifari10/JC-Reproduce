...
load('/home/yusuf/Yusuf/Kuliah/AI/Project/ICU/JC-Reproduce/Repo Source/AI_Clinician/reference_matrices.mat');
tic
EXTRACTED_DIR = '/home/yusuf/Yusuf/Kuliah/AI/Project/ICU/JC-Reproduce/data/extracted/';
abx=table2array(readtable([EXTRACTED_DIR 'abx.csv']));
culture=table2array(readtable([EXTRACTED_DIR 'culture.csv']));
microbio=table2array(readtable([EXTRACTED_DIR 'microbio.csv']));
demog=(readtable([EXTRACTED_DIR 'demog.csv']));
ce010=table2array(readtable([EXTRACTED_DIR 'ce010000.csv']));
ce1020=table2array(readtable([EXTRACTED_DIR 'ce1000020000.csv']));
ce2030=table2array(readtable([EXTRACTED_DIR 'ce2000030000.csv']));
ce3040=table2array(readtable([EXTRACTED_DIR 'ce3000040000.csv']));
ce4050=table2array(readtable([EXTRACTED_DIR 'ce4000050000.csv']));
ce5060=table2array(readtable([EXTRACTED_DIR 'ce5000060000.csv']));
ce6070=table2array(readtable([EXTRACTED_DIR 'ce6000070000.csv']));
ce7080=table2array(readtable([EXTRACTED_DIR 'ce7000080000.csv']));
ce8090=table2array(readtable([EXTRACTED_DIR 'ce8000090000.csv']));
ce90100=table2array(readtable([EXTRACTED_DIR 'ce90000100000.csv']));
labU=[ table2array(readtable([EXTRACTED_DIR 'labs_ce.csv'])) ; table2array(readtable([EXTRACTED_DIR 'labs_le.csv']))  ];
MV=table2array(readtable([EXTRACTED_DIR 'mechvent.csv']));
inputpreadm=table2array(readtable([EXTRACTED_DIR 'preadm_fluid.csv']));
inputMV=table2array(readtable([EXTRACTED_DIR 'fluid_mv.csv']));
inputCV=table2array(readtable([EXTRACTED_DIR 'fluid_cv.csv']));
vasoMV=table2array(readtable([EXTRACTED_DIR 'vaso_mv.csv']));
vasoCV=table2array(readtable([EXTRACTED_DIR 'vaso_cv.csv']));
UOpreadm=table2array(readtable([EXTRACTED_DIR 'preadm_uo.csv']));
UO=table2array(readtable([EXTRACTED_DIR 'uo.csv']));
toc
...
%save cohort
writetable(sepsis,'/home/yusuf/Yusuf/Kuliah/AI/Project/ICU/JC-Reproduce/data/cohort/sepsis_mimiciii.csv','Delimiter',',');
